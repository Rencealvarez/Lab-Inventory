                            ...
                            return (
                                <div key={report.id} className="bg-white rounded-xl shadow-sm border border-[#e1f1fd] p-6 hover:shadow-md transition-shadow flex flex-col h-full">
                                    ...
                                    <div className="mt-auto pt-5 border-t border-[#f1f5f9] flex items-center justify-end gap-3">
                                        <button className="flex items-center gap-2 rounded-lg border border-[#d2deeb] bg-white px-4 py-2 text-[13px] font-semibold text-gray-600 shadow-sm hover:bg-gray-50 hover:text-gray-800 transition-colors">
                                            <Printer className="h-4 w-4" />
                                            Print
                                        </button>
                                        <button className="flex items-center gap-2 rounded-lg bg-[#1e293b] px-4 py-2 text-[13px] font-semibold text-white shadow-sm hover:bg-gray-800 transition-colors">
